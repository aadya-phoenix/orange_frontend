...
const routes: Routes = [
 ...
 {path:'tracker',component:DnaTrackerComponent,canActivate:[AuthenticationServiceGuard]},
 {path:'tracker/create',component:DnaTrackerCreateComponent,canActivate:[AuthenticationServiceGuard]},
 {path:'tracker/edit/:id',component:DnaTrackerCreateComponent,canActivate:[AuthenticationServiceGuard]},
