...
<<<<<<< HEAD:src/app/dashboard/open-course-session/open-course-session-routing.module.ts
...
>>>>>>> module2-open-course:src/app/dashboard/open-course/open-course-routing.module.ts
