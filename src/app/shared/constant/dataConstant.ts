export const dataConstant = {
  ...
  DesignStatus:{ total: 'total', closed: 'closed', close: 'close',draft: 'draft', pending: 'pending', rejected: 'rejected', submitted: 'submitted', transferred: 'transferred', reject: 'reject', forwarded:'forwarded', digital_learning:'digital_learning' ,forward:'forward',approve:'approve'
},
