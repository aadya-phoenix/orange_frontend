export const dataConstant = {
  ...
  SMEStatus: { total: 'total', contecntSupport: 'content-support', delivery: 'delivery', voiceOver: 'voice-over-learning', active: 'active', deactive:'deactive', draft:'draft', pending:'pending', reject: 'reject'},
